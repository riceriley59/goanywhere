...
.PHONY: install-deps
install-deps: golangci-lint gocover-cobertura ginkgo ## Install all dependencies.
...
gocover-cobertura: $(LOCALBIN) ## Download gocover-cobertura locally if necessary.
